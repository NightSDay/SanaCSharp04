...
namespace Matrix
{
    ...
    {
        public static int[,] MatrixGeneration(int N, int M, int min, int max)
        {
        ...
        public static int GetAmmountOfPositiveNumbers(int[,] matrix)
        {
            var count = 0;
            for (var i = 0; i < matrix.GetLength(0); i++)
            {
        ...
        public static int GetAmmountOfNotContainedZeroForRows(int[,] matrix)
        {
            var count = 0;
            for (var i = 0; i < matrix.GetLength(0); i++)
            {
        ...
        public static int GetAmmountOfContainedZeroForColumns(int[,] matrix)
        {
            var count = 0;
            for (var j = 0; j < matrix.GetLength(1); j++)
            {
        ...
        public static void PrintTransportMatrix(int[,] matrix)
        {
            ...
            for (var i = 0; i < matrix.GetLength(1); i++)
            {
                ...
                {
                    Console.Write(string.Format("{0,5}", matrix_t[i, j]));
                }
                Console.WriteLine();
            }
        }
        ...
        public static int GetRowIndexWithLargestSeria(int[,] matrix)
        {
            var counter = 1;
